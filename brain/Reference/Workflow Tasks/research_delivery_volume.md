...
managed: true
source_path: "workflow/tasks/research_delivery_volume.md"
---
# research delivery volume

> Managed mirror of `workflow/tasks/research_delivery_volume.md`. Edit the source file, not this copy.
