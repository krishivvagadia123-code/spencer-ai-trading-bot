...
managed: true
source_path: "workflow/tasks/record_delivery_eval_rejection.md"
---
# record delivery eval rejection

> Managed mirror of `workflow/tasks/record_delivery_eval_rejection.md`. Edit the source file, not this copy.
