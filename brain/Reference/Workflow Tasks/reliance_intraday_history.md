...
managed: true
source_path: "workflow/tasks/reliance_intraday_history.md"
---
# reliance intraday history

> Managed mirror of `workflow/tasks/reliance_intraday_history.md`. Edit the source file, not this copy.
