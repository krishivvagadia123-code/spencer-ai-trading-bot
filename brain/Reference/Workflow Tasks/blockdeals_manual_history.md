...
managed: true
source_path: "workflow/tasks/blockdeals_manual_history.md"
---
# blockdeals manual history

> Managed mirror of `workflow/tasks/blockdeals_manual_history.md`. Edit the source file, not this copy.
