...
managed: true
source_path: "workflow/tasks/one_stock_reliance_reset.md"
---
# one stock reliance reset

> Managed mirror of `workflow/tasks/one_stock_reliance_reset.md`. Edit the source file, not this copy.
