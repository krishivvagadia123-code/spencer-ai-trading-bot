...
managed: true
source_path: "workflow/tasks/live_paper_execution_engine.md"
---
# live paper execution engine

> Managed mirror of `workflow/tasks/live_paper_execution_engine.md`. Edit the source file, not this copy.
